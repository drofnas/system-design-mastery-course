...
- **Access:** free
- **Week/time:** Week 71; 70 minutes assigned
...
- **Access:** free
- **Week/time:** Week 71; 60 minutes assigned
...
- **Access:** free
- **Week/time:** Week 70; 90 minutes assigned
...
- **Access:** free
- **Week/time:** Week 71; 75 minutes assigned
...
- **Type/status:** maintainer guidance; Required
- **Access:** free
- **Week/time:** Week 70; 70 minutes assigned
...
- **Access:** free
- **Week/time:** Week 74; 65 minutes optional
...
- **Type/status:** maintainer guidance; Optional enrichment
- **Access:** free
- **Week/time:** Week 74; 70 minutes optional
...
- **Access:** free
- **Week/time:** Week 74; 90 minutes optional
...
- **Access:** free
- **Week/time:** Week 74; 55 minutes optional
...
### RES-14: Secure Software Development Framework

- **Author/publisher:** NIST
- **URL:** https://csrc.nist.gov/projects/ssdf
- **Type/status:** official primary guidance; Required
- **Access:** free
- **Week/time:** Week 70; 20 minutes assigned
...
- **Boundary and evidence:** Read the SSDF practices and use sections; map applicable outcomes to source, build, release, and vulnerability-response evidence.
- **Local alternative:** [lessons/08-prompt-injection-tool-authorization-decisions.md](lessons/08-prompt-injection-tool-authorization-decisions.md)
...
- **Week/time:** Week 70; 20 minutes assigned
- **Purpose:** Ground the PESD 2.0 cross-cutting decision in current primary guidance and produce scoped evidence rather than framework vocabulary.
- **Boundary and evidence:** Read the overview and current publications boundary; inventory algorithms and plan replacement without claiming a universal migration schedule.
- **Local alternative:** [lessons/08-prompt-injection-tool-authorization-decisions.md](lessons/08-prompt-injection-tool-authorization-decisions.md)
- **Verification:** verified; HTTP GET plus primary-source metadata comparison; last checked 2026-08-04
- **Reflection:** Which obligation applies, which evidence proves its control, and what uncertainty or failure would reverse the decision?
