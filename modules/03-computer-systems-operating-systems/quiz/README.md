...
Use this quiz package to check your understanding of **Computer Systems and Operating Systems**.
...
```bash
python3 scripts/generate_quiz.py --module M03 --output quiz-m03.json
```
