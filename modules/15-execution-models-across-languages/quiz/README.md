...
Use this quiz package to check your understanding of **Execution Models Across Languages**.
...
```bash
python3 scripts/generate_quiz.py --module M15 --output quiz-m15.json
```
