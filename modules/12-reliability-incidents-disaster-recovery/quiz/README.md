...
Use this quiz package to check your understanding of **Reliability, Incidents, and Disaster Recovery**.

- `question-bank.json` contains 16 short-answer and calculation questions covering this module's mechanisms and quantitative reasoning. Multiple-choice, scenario-diagnosis, and design-judgment questions were removed in the cleanup of August 6, 2026 because they did not reliably test the material; they will return when they can be written to the same standard.
...
```bash
python3 scripts/generate_quiz.py --module M12 --output quiz-m12.json
```
