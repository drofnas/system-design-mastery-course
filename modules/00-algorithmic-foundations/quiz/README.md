...
Use this quiz package to check your understanding of **Algorithmic Foundations**.

- `question-bank.json` contains 20 short-answer and calculation questions covering this module's mechanisms and quantitative reasoning. Multiple-choice, scenario-diagnosis, and design-judgment questions were removed in the cleanup of August 6, 2026 because they did not reliably test the material; they will return when they can be written to the same standard.
