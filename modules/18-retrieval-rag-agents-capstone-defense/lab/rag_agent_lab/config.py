...
def validate_trial(trial: dict[str, Any]) -> list[str]:
    required = {"module_id", "schema_version", "scenario_id", "pair_id", "variant", "seed", "evidence_kind", "shared_input_sha256", "config_sha256", "toolchain", "retrieval", "answer", "workflow", "budget", "audit", "cost", "invariants", "limitations"}
    errors: list[str] = []
