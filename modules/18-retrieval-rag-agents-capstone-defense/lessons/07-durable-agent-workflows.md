...
Read the bounded Temporal reference assignment in [resources.md](../resources.md), distinguishing general durable-execution principles from product features. Complete EX-15 through EX-18. Lesson 8 integrates these mechanisms into a defensible capstone decision.
