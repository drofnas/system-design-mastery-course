...
Keep the original submission, Week 21 freeze, scenarios, raw trials, policy, and
evaluation immutable. Put corrections in a dated addendum and rerun only the
smallest evidence needed.

| Finding area | Lessons | Exercises | New evidence |
|---|---|---|---|
| Deadline graph/allocation | Lesson 1 | EX-01–EX-02 | call-budget addendum and whole-journey rerun |
| Cancellation/cleanup | Lesson 2 | EX-03–EX-04 | cancel-timing matrix and drain evidence |
| Retry amplification/budget | Lesson 3 | EX-05–EX-06 | attempt tree and sustained-recovery rerun |
| Idempotency/ambiguity | Lesson 4 | EX-07–EX-08 | concurrent/crash/replay addendum |
| Pools/health/fairness | Lessons 5, 7 | EX-09, EX-12 | bounded skew/drain/failover rerun |
