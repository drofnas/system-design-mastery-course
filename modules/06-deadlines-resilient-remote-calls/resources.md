...
- **Purpose:** Examine failure containment, traffic shifting, operational ownership, and recovery in a large commerce platform without using it as a optional project answer.
