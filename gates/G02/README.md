# G02: Standalone Course Gate

Week 33 assesses Modules M04, M05, M06. It contains no new required
...
| Part | Time |
|---|---:|
| Evidence freeze | 30 min |
| Written examination | 75 min |
| Hidden practical | 150 min |
| Architecture defense | 60 min |
| Portfolio review | 45 min |
| Scoring and feedback review | 30 min |

Each scored part, each module-domain subscore, and each safety-critical row must
score at least 3.0. The overall floor is 3.0.
