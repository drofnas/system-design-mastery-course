# G06: Standalone Course Gate

Week 103 assesses Modules M16, M17, M18. It contains no new required
...
| Part | Time |
|---|---:|
| Final evidence freeze | 30 min |
| Written examination | 90 min |
| Hidden practical | 180 min |
| Architecture defense | 120 min |
| Longitudinal portfolio review | 90 min |
| Scoring and closure | 60 min |

Each scored part, each module-domain subscore, and each safety-critical row must
score at least 3.0. The overall floor is 3.5.
