...
| 6–18 | 21–72 | Syllabus-defined; teaching packages not yet authored | [Course syllabus](00_COURSE_SYLLABUS.md) |
...
local Markdown links. Use `--module M01` through `--module M05` to validate a
single module.
