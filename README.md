...
| 17–18 | 65–72 | Syllabus-defined; teaching packages not yet authored | [Course syllabus](00_COURSE_SYLLABUS.md) |
...
local Markdown links. Use `--module M01` through `--module M16` to validate a
single module.
